/*
  ...
  --------------------------------------------------
  Gestisce menu principale, legenda, archivio e spostamento toolbar nel menu.
*/
...
(function () {
  ...
  function setupTopMenu() {
    ...
    archiveWrap.innerHTML = `<button id="archiveSubmenuBtn" type="button" class="archive-submenu-btn" aria-expanded="false">Archivio ▸</button><div id="archiveSubmenuPanel" class="archive-submenu-panel"><button id="monthlyArchiveSubmenuBtn" type="button" class="archive-submenu-link archive-nested-btn" aria-expanded="false">Archivio mensile ▸</button><div id="monthlyArchiveMonths" class="archive-months-panel">${createMonthlyLinks(today)}</div><button id="weeklyArchiveSubmenuBtn" type="button" class="archive-submenu-link archive-nested-btn" aria-expanded="false">Archivio settimanale ▸</button><div id="weeklyArchiveWeeks" class="archive-weeks-panel">${createWeeklyLinks(today)}</div></div>`;
